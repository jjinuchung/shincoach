...
export const RARITY_IDS = {
  1: [1, 4, 7, 152, 155, 158, 393, 39, 52, 54, 58, 104, 129,
      ...
      // 2026-09-20 추가분 — PokeAPI 포획률 120 이상 (캐터피·구구·디그다·마릴·비버니·요테리·우르…)
      10, 16, 50, 60, 74, 79, 81, 161, 183, 216, 228, 263, 311, 312, 399, 403, 417, 418, 427, 506, 572, 587, 607, 613,
      661, 674, 679, 702, 714, 744, 759, 761, 777, 831, 835, 872, 877, 915, 921, 926, 940, 957,
  ...
  2: [25, 133, 175, 143, 131, 94, 26, 95, 113,
      ...
      888, 889, 380, 381, 386, 645, 646, 800, 890,
      // 2026-09-20 추가분 — 포획률 45~119 (스타터·꼬지모·헤라크로스·밀탱크·딥상어동·조로아·드라꼰…)
      185, 214, 241, 252, 255, 258, 390, 443, 501, 570, 653, 722, 725, 813, 885, 909,
